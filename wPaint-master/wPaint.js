...
(function($)
{
	...
	$.fn.wPaint.defaultSettings = {
		...
		fontSizeMax			 : '50',				// max font size in px
		fontSize			 : '12',				// current font size for text input
		fontFamilyOptions	 : ['宋体', '方正舒体', '幼圆', '楷体', '华文行楷','华文彩云','Brush Script MT'], // available font families
		fontFamily			 : '宋体',				// active font family for text input
